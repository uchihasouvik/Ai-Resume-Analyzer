...
def run():
    ...
    link = '[©Developed by Souvik](https://www.linkedin.com/in/souvik-mandal-723001137/)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'souvik' and ad_password == 'souvik1234':
                st.success("Welcome Sovuik Mandal !")
                # Display Data
